#!/usr/bin/env python3
"""
Test script to demonstrate the new Impact × Likelihood = Business Risk calculation method.
"""
...
from src.driftbuddy.risk_assessment import RiskMatrix, ImpactLevel, LikelihoodLevel
