...
class TestRiskAssessment:
    ...
    def test_risk_assessment(self):
        ...
        assessment = RiskMatrix.assess_risk(
    ...
    def test_unknown_query_fallback(self):
        ...
        assessment = RiskMatrix.assess_risk(
            "Unknown Security Query",
            "MEDIUM",
            "Some security issue"
        )
        
        # Should still provide a valid assessment
        assert assessment.impact in [ImpactLevel.CRITICAL, ImpactLevel.HIGH, ImpactLevel.MEDIUM, ImpactLevel.LOW, ImpactLevel.MINIMAL]
        assert assessment.likelihood in [LikelihoodLevel.VERY_HIGH, LikelihoodLevel.HIGH, LikelihoodLevel.MEDIUM, LikelihoodLevel.LOW, LikelihoodLevel.VERY_LOW]
        assert assessment.business_risk in [BusinessRiskLevel.CRITICAL, BusinessRiskLevel.HIGH, BusinessRiskLevel.MEDIUM, BusinessRiskLevel.LOW, BusinessRiskLevel.MINIMAL]
